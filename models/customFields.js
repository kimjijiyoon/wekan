...
CustomFields.attachSchema(
  new SimpleSchema({
    ...
    'settings.apiUrl': {  // API URL 설정 추가 -- 지윤 추가
      type: String,
      optional: true,
    },
    'settings.apiMethod': {  // API URL 설정 추가 -- 지윤 추가
      type: String,
      optional: true,
      allowedValues: ['GET', 'POST'],
      defaultValue: 'POST'
    },
    'settings.maxDepth': {  // API URL 설정 추가 -- 지윤 추가
      type: Number,
      optional: true,
      max: 3,
      defaultValue: 1
    },
    'settings.depthSeparator': {  // API URL 설정 추가 -- 지윤 추가
      type: String,
      optional: true,
      defaultValue: '/'
    },
